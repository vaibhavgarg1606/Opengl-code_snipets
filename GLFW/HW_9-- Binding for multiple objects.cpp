...
We Unbind and Bind everything like shader buffer ibo in while loop so that we can see what needed to be done to display multiple objects with different vertex data 
